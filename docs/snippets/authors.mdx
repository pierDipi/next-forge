                    ...
                    <div style={{position: 'relative'}}>
                        <div style={{
                            ...
                            <img
                                ...
                                src={`https://docs.next-forge.com/images/authors/${author.company.id}/${author.user.id}.jpg`}
                                alt=""
                                width={32}
                                height={32}
                            />
                        ...
                        >
                            <img
                                style={{margin: 0, width: '100%', height: '100%'}}
                                src={`https://docs.next-forge.com/images/authors/${author.company.id}/logo.jpg`}
                                alt=""
                                width={16}
                                height={16}
                            />
