...
export const Hero = () => (
  <div
    className="mx-2 mt-2 rounded-4xl bg-neutral-50 ring-1 ring-black/5 ring-inset dark:bg-neutral-950">
    <section
      className="container mx-auto flex max-w-4xl flex-col items-center gap-2 py-24 sm:py-32">
      <Image
        src={Logo}
        alt="Logo"
        width={48}
      ...
      />
      <h1
        className="mt-8 text-center font-bold text-3xl leading-tight tracking-tighter md:text-6xl lg:leading-[1.1]">
        Production-grade{' '}
        <Image
          src={TurborepoLogo}
          alt=""
      ...
      <p
        className="mt-6 max-w-xl text-pretty text-center text-neutral-950/70 sm:text-lg dark:text-white/70">
